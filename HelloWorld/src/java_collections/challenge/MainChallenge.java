package java_collections.challenge;
...
public class MainChallenge {
    ...
    It should also be possible to "unreserved" items that were added to the basket
    by mistake.

    The program should prevent any attempt to unreserved more items than were
    reserved for a basket.

    Add code to Main that will unreserved items after they have been added to the basket,
    as well as undeserving items that have not been added to make sure that the code
